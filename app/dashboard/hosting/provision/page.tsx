      ...
      <div className="flex flex-col gap-7 max-w-2xl mx-auto">
        ...
        <div>
          ...
          <p className="text-[#5a6a85] mt-1 text-sm">
            Set up a new hosting account. Your cPanel credentials will be
            generated instantly.
          </p>
        </div>
          ...
          <div className="bg-white border border-[#e2eaff] p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-[11px] text-[#9ba8c0]">
                Make sure you have access to this domain's DNS settings to
        ...
        <div className="flex gap-2 text-xs text-[#5a6a85]">
          ...
          <p>
            Your hosting account will be provisioned instantly. cPanel
            credentials and nameservers will be provided upon completion.
          </p>
        </div>
      </div>
    </>
