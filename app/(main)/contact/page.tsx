...
export default function ContactPage() {
  ...
  return (
    <>
      {/* Page header */}
      <section className="pt-24 pb-10 sm:pt-28 sm:pb-12 bg-[#f8faff] border-b border-[#e2eaff] relative overflow-hidden">
        <div className="absolute inset-0 grid-bg pointer-events-none opacity-40" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center sm:text-left">
          <span className="type-caption text-[#1787D4] mb-3 block">
            Get In Touch
          </span>
      ...
      <section className="section-pad bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-0 border border-[#e2eaff] rounded-2xl overflow-hidden shadow-sm">

            {/* ── Left: Contact info ──────────────────────────────────── */}
            <div className="lg:col-span-2 bg-[#031033] p-8 lg:p-10 flex flex-col gap-8">
              <div>
                <h2 className="text-xl font-semibold text-white mb-2 tracking-tight">Contact Information</h2>
              ...
              <div className="flex flex-col gap-5">
                {contactInfo.map(({ icon: Icon, label, value, href }) => (
                  <div key={label} className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-semibold tracking-wider uppercase text-[#9ba8c0] mb-0.5">{label}</p>
                      {href ? (
                        <a href={href} className="text-white text-sm font-medium hover:text-[#1787D4] transition-colors">
                          {value}
                        </a>
                      ) : (
              ...
              {/* Socials */}
              <div>
                <p className="text-[10px] font-semibold tracking-wider uppercase text-[#9ba8c0] mb-3">Follow Us</p>
                <div className="flex items-center gap-3">
                  {socials.map(({ Icon, label, href }) => (
                    <a
                      ...
                      className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-[#9ba8c0] hover:text-white hover:bg-white/20 transition-all"
                    >
              ...
              {/* Decorative blue bar */}
              <div className="mt-auto h-1 w-16 bg-[#1787D4] rounded-full" />
            </div>
            ...
            <div className="lg:col-span-3 bg-white p-8 lg:p-10">
              {submitted ? (
                <div className="h-full flex flex-col items-center justify-center text-center py-16">
                  ...
                  <h3 className="type-h3 text-[#031033] mb-2">Message Sent!</h3>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="contact-email" className="text-xs font-semibold text-[#031033] tracking-wide uppercase">
                        Email Address <span className="text-[#1787D4]">*</span>
                      </label>
                      <input
                        id="contact-email"
                        name="email"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="contact-subject" className="text-xs font-semibold text-[#031033] tracking-wide uppercase">
                      Subject <span className="text-[#1787D4]">*</span>
                    </label>
                    <select
                      id="contact-subject"
                      name="subject"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="contact-message" className="text-xs font-semibold text-[#031033] tracking-wide uppercase">
                      Message <span className="text-[#1787D4]">*</span>
                    </label>
                    <textarea
                      id="contact-message"
                      name="message"
      ...
      {/* FAQ strip */}
      <section className="section-pad bg-[#f8faff] border-t border-[#e2eaff]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="type-h3 text-[#031033] mb-2">Looking for quick answers?</h2>
          <p className="type-lead max-w-xl mx-auto mb-6">
            Browse our documentation or open a support ticket directly from your dashboard.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/help" className="btn-primary text-sm py-2.5 px-6 !rounded-full">
              Help Center
            </Link>
            <Link href="/login" className="btn-outline text-sm py-2.5 px-6 !rounded-full">
              Open a Ticket
            </Link>
          </div>
        </div>
